...
mkdir -p ${INSTDIR}/usr/local/lib/python3.10/dist-packages/takin
...
# copy py modules
cp -v pymods/*			${INSTDIR}/usr/local/lib/python3.10/dist-packages/takin
...
strip -v ${INSTDIR}/usr/local/lib/python3.10/dist-packages/takin/*.so
